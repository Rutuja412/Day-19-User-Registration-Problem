...
namespace UC7_Rule3
{
    ...
    {//uc1-FirstNAME
        ...
        //UC7 Rule 3 at least 1 numeric number
        public static string PasswordRule = ("^[A-Z]{1,}[a-z]{6}[0-9]{1,}$");
        public bool validate_PasswordRule(string passwordrule)
        {
        return Regex.IsMatch(passwordrule, PasswordRule);
        }
     
        //uc8 Rule4 1special chara
        public static string FinalPassword= ("^[A-Z]{1,}[a-z]{1,}[!@#$&]{1}[0-9]{1,}$");
        
        public bool validate_FinalPassword(string finalpassword)
        {
            return Regex.IsMatch(finalpassword,FinalPassword);
        }
